...
bool runPrims(const string& inputFile, const string& outputFile)
{
    ...
    output << "Algorithm: Prim's MST" << endl;
...
int main()
{
    ...
    {
        "output/mst_10_prims.txt",
        "output/mst_100_prims.txt",
        "output/mst_10000_prims.txt",
        "output/mst_50000_prims.txt",
        "output/mst_100000_prims.txt"
    };
